...
class Common:
    ...
    def compute_bleu(ref_file_name, predicted_file_name):
        command = 'perl %s %s < %s' % ('./multi-bleu.perl', ref_file_name, predicted_file_name)
...
if __name__ == '__main__':
    stdout, stderr = Common.compute_bleu('./models/commit.5/pred.txt', './models/commit.5/ref.txt')
