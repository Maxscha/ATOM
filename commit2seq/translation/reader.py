...
class Reader:
    ...
    def compute_output(self):
        dataset = tf.data.experimental.CsvDataset(self.file_path, record_defaults=[tf.string, tf.string, tf.string, tf.string], header=True, buffer_size=self.config.CSV_BUFFER_SIZE)   #automaticly fill with records_defaults
