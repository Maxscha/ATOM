...
class GRU(nn.Module):
    def __init__(self, diff_vectors, msg_vectors):
        ...
        self.encoder_diff = nn.GRU(256, self.lstm_dim, bidirectional=True, batch_first=True)
        self.encoder_msg = nn.GRU(self.lstm_dim, self.lstm_dim, bidirectional=True, batch_first=True)
